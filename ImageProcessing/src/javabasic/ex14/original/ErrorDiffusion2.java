...
public class ErrorDiffusion2 extends OperationViewer {

  public ErrorDiffusion2(String imageFile) throws IOException, ImageDecoderException, OperationException {
    super(imageFile);
  ...
  public static void main(String[] argv) {
    if (argv.length > 0) {
      try {
        JFrame frame = new ErrorDiffusion2(argv[0]);
        frame.pack();
