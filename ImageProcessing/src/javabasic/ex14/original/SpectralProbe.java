package javabasic.ex14.original; /***************************************************************************
  SpectralProbe.java  :  This program reads an image from a file named on the command line 
  and performs an FFT to compute the spectrum of a small, square region of interest, defined 
  by the user.  The logarithmically scaled spectrum is displayed alongside the image. 
  A ROI is defined by clicking at a particular location in the image.  A control panel is provided 
  to allow different ROI sizes and windowing functions to be selected.
***************************************************************************/
import java.awt.*;
