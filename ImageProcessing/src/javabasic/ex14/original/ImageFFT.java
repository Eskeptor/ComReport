 ...
 * The transformed data can be inspected or filtered before performing the inverse transform. */
...
public class ImageFFT {
  ...
  /* Creates an ImageFFT for the specified image.  There will be no windowing 
   * of image data.
  ...
  /* Creates an ImageFFT for the specified image, applying the specified windowing 
  ...
  /* Transforms data via a forward or inverse FFT, as appropriate. An inverse transform 
   * is computed if the previous transform was in the forward direction; otherwise, 
   * the forward transform is computed. */
   ...
   * exception FFTException if the data are in spectral form; 
   * an image can be created only from data in the spatial domain. */
  ...
  public BufferedImage toImage(BufferedImage image, int bias) throws FFTException {
    if (spectral)
  ...
  /* Returns the amplitude spectrum of an image, as another image. The data are shifted 
   * such that the DC component is at the image centre, and scaled logarithmically so that 
  ...
  /* Returns the amplitude spectrum of an image, as another image. The data are unshifted 
   * and are scaled logarithmically so that low-amplitude detail is visible.
   ...
   * return magnitude at the specified point, or zero if point does not exist.
   * @exception FFTException if spectral data are not available.   */
   ...
   * param radius filter radius
   * exception FFTException if spectral data are not available or filter radius is invalid. */
   ...
   * param radius filter radius
   * param delta band width
   * exception FFTException if spectral data are not available or filter parameters are invalid. */
  ...
  ///////////////////////////// PRIVATE METHODS ////////////////////////////
  /* Computes the power of two for which the corresponding value equals or exceeds 
  ...
  /* Reorders an array of data to prepare for an FFT.  The element at index i is swapped with 
   * the element at an index given by the bit-reversed value of i.
