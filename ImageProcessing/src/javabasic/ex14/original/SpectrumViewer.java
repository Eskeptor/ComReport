package javabasic.ex14.original; /***************************************************************************
  SpectrumViewer.java  : This program reads an image from a file named on the command line 
  and performs an FFT to compute its spectrum.  The logarithmically scaled spectrum is 
  displayed alongside the image.  Radiobuttons are provided to allow the view to be toggled 
  between a shifted and an unshifted spectrum.  An information panel displays horizontal and 
  vertical spatial frequency, magnitude and phase for the point under the cursor, when the cursor 
  is positioned over the spectrum.
***************************************************************************/
import java.awt.*;
