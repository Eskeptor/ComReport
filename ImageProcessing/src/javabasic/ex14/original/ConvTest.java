...
public class ConvTest {
  private static final float[] coeff = { -1.0f, -1.0f, -1.0f,  -1.0f, 8.0f, -1.0f,  -1.0f, -1.0f, -1.0f  };

  private Raster source;
  private Raster result;
  private StreamTokenizer input = new StreamTokenizer(new InputStreamReader(System.in));;
  private int[][] neighbourhood = new int[3][3];

  public ConvTest(String imageFile) throws IOException, ImageDecoderException {
