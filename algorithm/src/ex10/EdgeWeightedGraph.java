 ...
 *
 ******************************************************************************/
/*  The EdgeWeightedGraph class represents an edge-weighted graph of vertices named 0 through V-1, 
 *  where each undirected edge is of type Edge and has a real-valued weight. It supports the following 
 *  two primary operations: add an edge to the graph, iterate over all of the edges incident to a vertex. 
 ...
 *  Bag objects. All operations take constant time (in the worst case) except iterating over the edges 
 *  incident to a given vertex, which takes time proportional to the number of such edges. */
