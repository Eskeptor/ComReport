 ...
 *
 ******************************************************************************/
/*  The DirectedDFS class represents a data type for determining the vertices reachable from a 
 *  given source vertex s (or set of source vertices) in a digraph. For versions that find the paths,
 *  see DepthFirstDirectedPaths and BreadthFirstDirectedPaths. This implementation uses 
 *  depth-first search. The constructor takes time proportional to V + E (in the worst case),
