...
public final class StdIn {
    ...
    // all methods changed from "public" to "public static"

   /* Returns true if standard input is empty (except possibly for whitespace).
    * Use this method to know whether the next call to readString(), readDouble(), 
    * etc will succeed.
   ...
   /* Returns true if standard input has a next line. Use this method to know whether the
    * next call to readLine() will succeed. This method is functionally equivalent to hasNextChar().
    * return true if standard input has more input (including whitespace); false otherwise  */
    public static boolean hasNextLine() {
        return scanner.hasNextLine();
    }

    /* Returns true if standard input has more input (including whitespace). Use this method to 
     * know whether the next call to readChar() will succeed.
    ...
    * return the next line, excluding the line separator if present; null if no such line */
    ...
    * throws InputMismatchException if the next token cannot be parsed as a byte  */
    ...
    // end: code duplicated from In to StdIn
