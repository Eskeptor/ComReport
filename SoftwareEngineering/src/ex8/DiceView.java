...
public class DiceView extends Frame {
    ...
    public DiceView(final String _playerName, final DiceGame _dicegame) {
        ...
        mBoard = mDicegame.createDiceGame(30);
        mCell1 = new Label();
        mCell2 = new Label();
        mPanel1 = new Panel();
        mPanel2 = new Panel();
        ...
        rollBtn.addActionListener((e)->{
            WinningStatus ws = mBoard.roll();
            mDiceTf1.setText(String.valueOf(mBoard.getFaceValue1()));
            mDiceTf2.setText(String.valueOf(mBoard.getFaceValue2()));
            if (ws == WinningStatus.NotYet) {
                mCell1.setText(String.valueOf(mBoard.getCurCellPos1()));
                mCell2.setText(String.valueOf(mBoard.getCurCellPos2()));
            } else {
                String message;
